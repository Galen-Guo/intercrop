...
###
####################################################################
# for i in `awk '{print $1}' $WORK/NS.1725.plot4`;
# do
# echo $i
...
F=$(echo $(ls $TRIM/plot4/NS.1725.F8P*.pair1.fq.gz)  | sed "s/ /,/g")
R=$(echo $(ls $TRIM/plot4/NS.1725.F8P*.pair2.fq.gz)  | sed "s/ /,/g")

megahit -1 $F -2 $R -o $MEGAHIT/1725/plot4/ -t 12 --min-contig-len 1000 --continue  --k-min 37 --k-max 77 --k-step 10
