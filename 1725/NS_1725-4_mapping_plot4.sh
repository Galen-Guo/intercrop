...
mkdir $MAPPING
mkdir $MAPPING/1725/
mkdir $MAPPING/1725/plot4
cd $MAPPING/1725/plot4



bowtie2-build $ANVIO/1725/plot4/plot4_1725_contigs.fa $MAPPING/1725/plot4/plot4_contigs --threads 24 --large-index
...
sam="${sample}.sam"
bowtie2 -x $MAPPING/1725/plot4_contigs -1 $TRIM/plot4/$R1 -2 $TRIM/plot4/$R2 -S $MAPPING/1725/plot4/$sam --threads 24
done
...
sam=".sam"
bam=".bam"
samtools view -S -b $MAPPING/1725/plot4/${sample}.sam > $MAPPING/1725/plot4/${sample}.bam
done
...
anvi-init-bam $MAPPING/1725/plot4/${sample}.bam -o $MAPPING/1725/plot4/${sample}_anvi.bam
