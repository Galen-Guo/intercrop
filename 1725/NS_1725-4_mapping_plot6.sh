...
mkdir $MAPPING
mkdir $MAPPING/1725/
mkdir $MAPPING/1725/plot6
cd $MAPPING/1725/plot6



bowtie2-build $ANVIO/1725/plot6/plot6_1725_contigs.fa $MAPPING/1725/plot6/plot6_contigs --threads 24 --large-index
...
sam="${sample}.sam"
bowtie2 -x $MAPPING/1725/plot6_contigs -1 $TRIM/plot6/$R1 -2 $TRIM/plot6/$R2 -S $MAPPING/1725/plot6/$sam --threads 24
done
...
sam=".sam"
bam=".bam"
samtools view -S -b $MAPPING/1725/plot6/${sample}.sam > $MAPPING/1725/plot6/${sample}.bam
done
...
anvi-init-bam $MAPPING/1725/plot6/${sample}.bam -o $MAPPING/1725/plot6/${sample}_anvi.bam
done
