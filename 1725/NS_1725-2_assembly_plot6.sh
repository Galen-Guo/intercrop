...
###
####################################################################
# for i in `awk '{print $1}' $WORK/NS.1725.plot34`;
# do
# echo $i
...
# done
#
# for i in `awk '{print $1}' $WORK/NS.1725.plot5`;
# do
# echo $i
...
# done
#
# for i in `awk '{print $1}' $WORK/NS.1725.plot6`;
# do
# echo $i
...
F=$(echo $(ls $TRIM/plot6/NS.1725.F8P*.pair1.fq.gz)  | sed "s/ /,/g")
R=$(echo $(ls $TRIM/plot6/NS.1725.F8P*.pair2.fq.gz)  | sed "s/ /,/g")

megahit -1 $F -2 $R -o $MEGAHIT/1725/plot6/ -t 12 --min-contig-len 1000 --continue  --k-min 37 --k-max 77 --k-step 10
