...
mkdir $MAPPING
mkdir $MAPPING/1718/
mkdir $MAPPING/1718/plot5
cd $MAPPING/1718/plot5



bowtie2-build $ANVIO/1718/plot5/plot5_1718_contigs.fa $MAPPING/1718/plot5/plot5_contigs --threads 24 --large-index
...
sam="${sample}.sam"
bowtie2 -x $MAPPING/1718/plot5_contigs -1 $TRIM/plot5/$R1 -2 $TRIM/plot5/$R2 -S $MAPPING/1718/plot5/$sam --threads 24
done
...
sam=".sam"
bam=".bam"
samtools view -S -b $MAPPING/1718/plot5/${sample}.sam > $MAPPING/1718/plot5/${sample}.bam
done
...
anvi-init-bam $MAPPING/1718/plot5/${sample}.bam -o $MAPPING/1718/plot5/${sample}_anvi.bam
