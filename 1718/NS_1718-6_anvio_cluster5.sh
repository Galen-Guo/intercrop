...
anvi-cluster-contigs -c $ANVIO/1718/plot5/plot5_1718_contigs.db -p $ANVIO/1718/plot5/profile_merged/PROFILE.db -C plot5_maxbin2 --driver maxbin2 -T 24 --just-do-it
