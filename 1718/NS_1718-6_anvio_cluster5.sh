...
anvi-cluster-contigs -c $ANVIO/1718/plot5/plot5_1718_contigs.db -p $ANVIO/1718/plot5/profile_merged/PROFILE.db -C anvio_derep_metabat2 --driver plot5_metabat2 -T 24 --just-do-it
